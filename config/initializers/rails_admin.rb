# RailsAdmin config file. Generated on August 27, 2013 08:51
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Mission', 'Admin']
  ...
  # config.excluded_models = ['Comment', 'Post', 'User']
